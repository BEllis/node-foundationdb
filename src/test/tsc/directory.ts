...
import {counterEncoding, HighContentionAllocator} from '../../../dist/js/directory'
import { startsWith } from '../../../dist/js/util'
import { defaultTransformer } from '../../../dist/js/transformer'
...
describe('directory layer', () => {
  ...
  describe('directories', () => {
    ...
    it('can make a directory', async function () {
    ...
    it('can move a directory', async () => {
      const db = testContext.db;
      const dl = new fdb.DirectoryLayer({
        contentSubspace: testContext.db.subspace.at('content'),
        nodeSubspace: testContext.db.subspace.at('\xfe'),
      })
