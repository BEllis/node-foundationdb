...
import * as fdb from '../src/main/ts'
import {
...
import {packPrefixedVersionstamp} from '../src/main/ts/versionstamp'
import { concat2, startsWith } from '../src/main/ts/util'
import {DirectoryError} from '../src/main/ts/directory'

import assert = require('assert')
import nodeUtil = require('util')
import * as chalk from 'chalk'
import fs = require('fs')
import { Transformer } from '../src/main/ts/transformer'
